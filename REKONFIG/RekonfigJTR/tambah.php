                       ...
                       <thead bgcolor="#f9f9f9">							
							...
							?>
			        			...
			        			?>
									<tr id='addrw0'>
			        				<td class="text-center">M</td>
									<td><input type="text" value="<?php echo $list->input_TR1M ?>"  maxlength="3" name="a" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR2M ?>"  maxlength="3" name="b" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR3M ?>"  maxlength="3" name="c" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR3AM ?>"  maxlength="3" name="d" class="form-control"/></td>
									<td><input type="text" value="<?php echo $list->input_TR4M ?>"  maxlength="3" name="e" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR4AM ?>"  maxlength="3" name="f" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)"  onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR5M ?>"  maxlength="3" name="g" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR6M ?>"  maxlength="3" name="h" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR6AM ?>"  maxlength="3" name="i" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_TR7M ?>"  maxlength="3" name="j" class="form-control"/></td>
									...
									<td><input type="text" value="<?php echo $list->input_gwm?>" maxlength="3" name="m" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_gwnm ?>"  maxlength="3" name="n" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->input_hgwm ?>" maxlength="3" name="o" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->input_sp ?>" maxlength="7" name="p" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->input_pondasi ?>" maxlength="3" name="q" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td >
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->input_utama ?>" maxlength="3" name="r" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->input_utamae ?>" maxlength="3" name="s" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->input_nonutama ?>" maxlength="3" name="t" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								</tr>
			        			<tr id='addrw1'>
			        				<td class="text-center">UB</td>
			        				<td><input type='text' value="<?php echo $list->input_TR1UB ?>" maxlength='3' name='a1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR2UB ?>" maxlength='3' name='b1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR3UB ?>" maxlength='3' name='c1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR3AUB ?>" maxlength='3' name='d1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR4UB ?>" maxlength='3' name='e1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR4AUB ?>" maxlength='3' name='f1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR5UB ?>" maxlength='3' name='g1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR6UB ?>" maxlength='3' name='h1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_TR6AUB ?>" maxlength='3' name='i1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type='text' value="<?php echo $list->input_TR7UB ?>" maxlength='3' name='j1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type='text' value="<?php echo $list->input_gwub ?>" maxlength='3' name='m1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->input_gwnub ?>" maxlength='3' name='n1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type='text' value="<?php echo $list->input_hgwub ?>" maxlength='3' name='o1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									</tr>
								<?php 
								endforeach; 
								}
			          ...
			          if($cekgmb==0)
					  ...
					  else
						 {
							foreach($gambar as $listhasil1):
						 	echo "<img style='height: 600px; width: 1020px;' src='".base_url()."assets/img/lokasi/Rekonfig JTR/".$listhasil1->gambar2."'/>";
							endforeach;
						}
						?>                               
			      </div>
