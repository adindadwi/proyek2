                   ...
                   <table id="lok_rejtm" class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								if($listhasil->mtsu=="1" AND $listhasil->ctivm=="1" AND $listhasil->cgu=="1")
								{
									$status="<span class='badge bg-green'>&nbsp;</span>";
								}
								elseif($listhasil->mtsu=="0" AND $listhasil->ctivm=="0" AND $listhasil->cgu=="0")
								{
	                   ...
	                   <br>               
	                   	<a class="btn btn-success" href="<?php echo base_url()?>RekonfigJTM/exporttoexcel/<?php echo $_SESSION['ryn'] ?>">Export Excel</a>
	...
	<div class="modal fade" id="inaddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div style="width: 800px" class="modal-dialog">
				...
				<table class="table table-bordered" border="2" width="100%">
					...
					<tbody>
					<tr>
						<input type="hidden" value="<?php echo $_SESSION['ryn'] ?>" name="ryn">
