...
<section class="content-header">
     <h1>Rekonfig Jaringan TM</h1>
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url()?>RekonfigJTM">lokasi</a></li>
            </ol>
</section>
     ...
     <!-- Page content -->
          <div class="row">
             ...
             <div class="box">
				...
				<form action="<?php echo base_url()?>RekonfigJTM/lokasi" method="POST">
					<div class="form-group">
                        <label for="nama" class="col-md-1 control-label">Rayon</label>
                        <div class="col-md-5">
							<select class="form-control11" name="rayon" id="select">
             ...
             <div class="box">
                <div style="background-color: #4db4f9;" class="box-header">
                    <h3 class="box-title"><font color="#f4f2f3">Uraian & Lokasi (Rayon <?php echo $_SESSION['ryn'] ?>)</font></h3>
                </div><!-- /.box-header -->
			    <div class="box-body table-responsive">
                   <table id="lok_rejtm" class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<form action="" method="post">
								...
								if($listhasil->sut=="1" AND $listhasil->citvm=="1" AND $listhasil->ugcable=="1")
								{
									$status="<span class='badge bg-green'>&nbsp;</span>";
								}
								elseif($listhasil->sut=="0" AND $listhasil->citvm=="0" AND $listhasil->ugcable=="0")
								{
								...
								<td width="175" class="text-center">
									...
									<input type="checkbox" name="sut<?=$listhasil->id?>">	
									<input type="checkbox" name="citvm<?=$listhasil->id?>">	
									<input type="checkbox" name="ugcable<?=$listhasil->id?>">	
									<?php }
								echo "</td></tr>";
								$i++;
								endforeach;
