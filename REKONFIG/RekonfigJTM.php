<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class RekonfigJTM extends CI_Controller
	{
		...
		public function tambahjtm()
        {
			...
			$data['sut']=$this->m_rekonfigjtm->showsutmfromdb($id)->result();
			$data['ticmv']=$this->m_rekonfigjtm->showmvticfromdb($id)->result();
			$data['cgu']=$this->m_rekonfigjtm->showugcfromdb($id)->result();
			$listhasil=$hasil->row();
			if($listhasil->sut==0)
				{
					$data['act']="in";
			...
			elseif($listhasil->sut==1 AND $listhasil->ticmv==0)
				{
					$data['act']="";
					$data['act1']="in";
					$data['act2']="";
				}
			elseif($listhasil->sut==1 AND $listhasil->ticmv==1 AND $listhasil->cgu==0)
				{
					$data['act']="";
					$data['act1']="";
					$data['act2']="in";
				}
			elseif($listhasil->sut==1 AND $listhasil->ticmv==1 AND $listhasil->cgu==1)
				{
					$data['act']="";
					$data['act1']="";
					$data['act2']="";
        ...
        if($this->form_validation->run()==true)
        {
				...
				{
					$config['upload_path']   = './assets/img/lokasi/Rekonfig JTM';
