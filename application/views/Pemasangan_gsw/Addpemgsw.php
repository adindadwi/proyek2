...
<section class="content-header">
     <h1>PRK.2015 DIT.1.7 </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-archive"></i> Pemasangan GSW</a></li>
              <li><a href="<?php echo base_url()?>PemGSW"><?php foreach($hasil as $listhasil): echo $listhasil->rayon; endforeach;?></a></li>
      ...
      <div class="row">
             ...
             <div class="box">
                <div style="background-color: #4db4f9;" class="box-header">
                    <h3 class="box-title"><font color="#f4f2f3">Pemasangan GSW 22 mm</font></h3>
                </div><!-- /.box-header -->
			...
			<?php echo form_open_multipart('PemGSW/do_upload','class="form-horizontal"'); ?>
			<table>
				<tr>
					<?php
					foreach($hasil as $listhasil):
		...
		<div class="box-body table-responsive">
			<div class="panel-group" id="accordion1">
			  <div class="panel panel-danger">
			    ...
			    <form action="<?php echo base_url()?>PemGSW/addgswline" method="POST" name="">
					...
					<table class="table table-bordered" width="100%" id="tab_logic">
                       <thead bgcolor="#f9f9f9">
						...
						?>
								...
								<td><input type="text"  maxlength="3" name="penyulang" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td><input type="text"  maxlength="3" name="satu" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td><input type="text"  maxlength="3" name="dua" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td><input type="text"  maxlength="3" name="tiga" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td><input type="text"  maxlength="3" name="pjg_gsw" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td><input type="text"  maxlength="3" name="est_jarak" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
