<section class="content-header">
     <h1>Trafo Sisip + Jaringan</h1>
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url()?>Trafosisipjar">lokasi</a></li>
            </ol>
</section>
     ...
     <!-- Page content -->
          <div class="row">
			 ...
			 <div class="box">
				...
				<form action="<?php echo base_url()?>Trafosisipjar/lokasi" method="POST">
             ...
             <div class="box">
                <div style="background-color: #4db4f9;" class="box-header">
                    <h3 class="box-title"><font color="#f4f2f3">PEMBANGUNAN TRAFO SISIPAN, DAN JARINGAN PENUNJANG ( SUTM, SUTR )</font></h3>
                </div><!-- /.box-header -->
			    <div class="box-body table-responsive">
                       ...
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								echo "<tr>";
									...
									echo "<td style='vertical-align: middle;' class='text-center'>".$listhasil->lokasi."</td>";
									echo "<td style='vertical-align: middle;' class='text-center'>".$listhasil->rayon."</td>";
									echo "<td class='text-center'>".$listhasil->exsist."<br>".$listhasil->penyulang."</td>";
									echo "<td style='vertical-align: middle;' class='text-center'>".$listhasil->jumlah_X."</td>";
									
									?>
								<td width="175" class="text-center">
								<?php if($_SESSION['rayon']!="Semua") {?>
								<a class="btn btn-xs btn-danger" title="Hapus Data"  href="<?php echo base_url()?>TrafoSisipJar/deletelok/<?php echo $listhasil->id_loktsj?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data' href='".base_url()."TrafoSisipJar/addline/".$listhasil->id_loktsj."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Ubah</a>";
								}else{ ?>
			  ...
			  <div style="width: 800px" class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <div class="row">
			         <form method="POST" action="<?php echo base_url()?>TrafoSisipJar/saveaddlokasi" class="form-horizontal" role="form">
				...
				<table class="table table-bordered" border="2" width="100%">
					...
					<tr>
						...
						<td style="vertical-align: middle" class="text-center" rowspan="2"><input type="text" name="jumlah_x" class="form-control1"></td>
					</tr>
					<tr>
