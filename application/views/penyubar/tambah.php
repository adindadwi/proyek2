 ...
 ?>
     <!-- Page content -->
      <div class="row">
			...
			<?php echo form_open_multipart('penyubar/uploadgambar','class="form-horizontal"'); ?>
			<table>
				<tr>
					<?php
					foreach($hasil as $listhasil):
		...
		<div class="box-body table-responsive">
			<div class="panel-group" id="accordion1">
			  <div class="panel panel-danger">
			    ...
			    <form action="<?php echo base_url()?>penyubar/addsutm" method="POST" name="mvline">
			  ...
			  <div class="panel panel-info">
			    ...
			    <div id="collapseSix" class="panel-collapse collapse">
			      <div class="panel-body">
			      	<form action="<?php echo base_url()?>penyubar/addmvtic" method="POST" name="dt">
			       	   <div style="border: 0px solid 00000; color: black; font-family: arial; height: auto; overflow: auto; padding: 4px; text-align: left; width: auto;">
			  ...
			  <div class="panel panel-success">
			    ...
			    <div id="collapseSeven" class="panel-collapse collapse">
			      <div class="panel-body">
			        <form action="<?php echo base_url()?>penyubar/addugc" method="POST" name="lvline">
			         <div style="border: 0px solid 00000; color: black; font-family: arial; height: auto; overflow: auto; padding: 4px; text-align: left; width: auto;">
			        	<table class="table table-bordered" width="100%" id="tab_logic">
			        		<thead bgcolor="#f9f9f9">
								<tr>
