...
<section class="content-header">
	 ...
	 <h3>- Penggantian JTM telanjang mencadi MVTIC 3X150 mm2 + 1X95 mm2</h3>
            <ol class="breadcrumb">
                       ...
                       <thead bgcolor="#f9f9f9">
								<tr>
									...
									<th style="vertical-align: middle;" class="text-center" colspan="3">
										JUMLAH X (kali)<br> Gangguan<br> dalam 3 bulan
									</th>
									<th style="vertical-align: middle;" class="text-center" rowspan="3">
										Aksi
									</th>
							...
							<?php
								...
								echo "<tr>";
									echo "<td class='text-center'>".$listhasil->NO_GAMBAR_M."</td>";
									...
									echo "</tr>";
								echo "<tr>";
									echo "<td>".$listhasil->NO_GAMBAR_UB."</td>";
