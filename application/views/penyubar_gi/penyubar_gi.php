...
<section class="content-header">
     <h1>PEMBANGUNAN PENYULANG BARU PERSIAPAN OPERASI TRAFO GI</h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-archive"></i> <?=$title?></a></li>
              <li><a href="<?php echo base_url()?>penyubar_gi">lokasi</a></li>
            </ol>
</section>
     ...
     <!-- Page content -->
          <div class="row">
			 ...
			 <div class="box">
				...
				<form action="<?php echo base_url()?>penyubar_gi/lokasi" method="POST">
                   ...
                   <table id="lok_rejtm" class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								<a class="btn btn-xs btn-danger" title="Hapus Member"  href="<?php echo base_url()?>penyubar_gi/hapuslok/<?php echo $listhasil->id?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data Member' href='".base_url()."penyubar_gi/tambahjtm/".$listhasil->id."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Edit</a>";
								}else{ ?>
	                   ...
	                   <br>               
	                   		<!--<a class="btn btn-success" href="<?php echo base_url()?>penyubar_gi/exporttoexcel/<?php echo $_SESSION['rayon'] ?>">Export Excel</a>-->
	                </div><!-- /.box-body -->
	            </div><!-- /.box -->
			</div>
		</div>
			  ...
			  <div style="width: 800px" class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <div class="row">
			         <form method="POST" action="<?php echo base_url()?>penyubar_gi/saveaddlokasi" class="form-horizontal" role="form">
