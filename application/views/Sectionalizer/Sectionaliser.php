          ...
          <div class="row">
             ...
             <div class="box">
                <div style="background-color: #4db4f9;" class="box-header">
                    <h3 class="box-title"><font color="#f4f2f3">SECTIONALIZER</font></h3> <br>  <small></small><br>
                </div><!-- /.box-header -->
			    ...
			    <div class="panel-heading">
			      <h4 class="panel-title">
			        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseFive">
			          Pengadaan dan Pemasangan Sectionalizer
			        </a>
			      </h4>
			    </div>
			    <div id="collapseFive" class="panel-collapse collapse">			    
			    <form action="<?php echo base_url()?>m_section/showlokfromdb" method="POST" name="mvline">
