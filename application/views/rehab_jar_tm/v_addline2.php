<section class="content-header">
  <h1>Input <small>Line</small></h1>
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()?>rehab_jar_tm"><?php foreach($hasil as $listhasil): echo $listhasil->rayon; endforeach;?></a></li>
      ...
      <!-- Page content --><div class="row">
    			 ...
    			 <table class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<?php
								...
								echo "<tr>";
									echo "<td class='text-center' rowspan='2'>".$listhasil1->no_gambar."</td>";
									echo "<td rowspan='2' class='text-center'>".$listhasil1->lokasi."</td>";
									echo "<td rowspan='2' class='text-center'>".$listhasil1->exsist."</td>";
			...
			<table>
				<tr>
					<?php
					foreach($hasil1 as $listhasil1):
					echo "<input type='hidden' value='".$listhasil1->id_lokmm3."' name='id_lok'>";
					endforeach;
					?>
			  ...
			  <div class="panel panel-danger">
			    ...
			    <div style="border: 0px solid 00000; color: black; font-family: arial; height: auto; overflow: auto; padding: 4px; text-align: left; width: auto;">
					...
					<table class="table table-bordered" width="100%" id="tab_logic">
						...
						<?php
						foreach($hasil1 as $listhasil1):
						echo "<input type='hidden' value='".$listhasil1->id_lokmm3."' name='id_lokmm3'>";
						endforeach;
						?>
							<tr id='addr0'>
