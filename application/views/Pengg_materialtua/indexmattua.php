     ...
     <!-- Page content -->
          <div class="row">
			 ...
			 <div class="box">
				...
				<form action="<?php echo base_url()?>Pengmattua/lokasi" method="POST">
             ...
             <div class="box">
                <div style="background-color: #4db4f9;" class="box-header">
                    <h3 class="box-title"><font color="#f4f2f3">PENGGANTIAN MATERIAL TUA</font></h3>
                </div><!-- /.box-header -->
			    <div class="box-body table-responsive">
                   <table id="lok_rejtm" class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								<a class="btn btn-xs btn-danger" title="Hapus Member"  href="<?php echo base_url()?>Pengmattua/deletemattua/<?php echo $listhasil->id?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data Member' href='".base_url()."Pengmattua/addmattua/".$listhasil->id."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Edit</a>";
								}else{ ?>
			   ...
			   <div style="width: 1000px; height: 600px" class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <div class="row">
			         <form method="POST" action="<?php echo base_url()?>Pengmattua/saveaddlokasi" class="form-horizontal" role="form">
