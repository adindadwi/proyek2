...
<section class="content-header">
     <h1>PRK.2015 DIT.1.11 </h1>
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url()?>Pengmattua"><?php foreach($hasil as $listhasil): echo $listhasil->rayon; endforeach;?></a></li>
...
<?php echo $_SESSION['log'];
 ...
 ?>
      ...
      <div class="row">
			...
			<?php echo form_open_multipart('Pengmattua/do_upload','class="form-horizontal"'); ?>
			<table>
				<tr>
					<?php
					foreach($hasil as $listhasil):
		...
		<div class="box-body table-responsive">
			<div class="panel-group" id="accordion1">
			  <div class="panel panel-danger">
			    ...
			    <form action="<?php echo base_url()?>Pengmattua/addmattualine" method="POST" name="">
