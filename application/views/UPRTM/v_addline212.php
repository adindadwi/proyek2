...
<?php echo $_SESSION['log'];
 ...
 ?>
      <!-- Page content --><div class="row">
			...
			<?php echo form_open_multipart("UpRTM/uploadgambar1"); ?>
			<table>
				<tr>
					<?php
					foreach($hasil as $listhasil):
			...
			<div class="panel-group" id="accordion1">
			  <div class="panel panel-danger">
			    ...
			    <form action="<?php echo base_url()?>UpRTM/addmvline1" method="POST" name="mvline">
					...
					<table class="table table-bordered" width="100%" id="tab_logic">
						...
						?>
							...
							<tr id='addr1'>
								...
								<td><input type='text'  maxlength='3' name='w1' onFocus='startCalc();' onBlur='stopCalc();' onKeyPress="return goodchars(event,'a0123456789',this)" class='form-control input-md' /></td>
