          ...
          <div class="row">
             ...
             <div class="box">
                <div style="background-color: #4db4f9;" class="box-header">
                    <h3 class="box-title"><font color="#f4f2f3">UP RATING SUTM</font></h3> <br>  <small></small><br>
                </div><!-- /.box-header -->
                   ...
                   <table id="lok_rdt" class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
						...
						?>
							<tr id='addr0'>
								<td>
								<select class="form-control" name="pasangan" id="select">
								...
								<td><input type="text"  maxlength="3" name="d" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();" id="dis1" disabled/></td>
								...
								<td><input type="text"  maxlength="3" name="g" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();" id="dis2" disabled/></td>
								<td><input type="text"  maxlength="3" name="h" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();" id="dis3" disabled/></td>
								...
								<td><input type="text"  maxlength="3" name="j" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();" id="dis4" disabled/></td>
								...
								<td rowspan="2"><input type="text"  maxlength="3" name="p" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td rowspan="2"><input type="text"  maxlength="3" name="q" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td >
								<td rowspan="2"><input type="text"  maxlength="3" name="r" class="form-control" readonly="yes" /></td>
								<td rowspan="2"><input type="text"  maxlength="3" name="s" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td rowspan="2"><input type="text"  maxlength="8" name="t" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td rowspan="2"><input type="text"  maxlength="3" name="u" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<td rowspan="2"><input type="text"  maxlength="3" name="v" class="form-control" readonly="yes" /></td>
								<td rowspan="2"><input type="text"  maxlength="3" name="w" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								
							</tr>
							<tr id='addr1'>
								<td><select class='form-control input-md' name='pasangan1' id='select' onchange='disableField(this)'><option selected value=""></option><option value='UB'>UB</option> </select></td>
			    ...
			    <div class="panel-heading">
			      <h4 class="panel-title">
			        <a data-toggle="collapse" data-parent="#accordion1" href="#collapseSix">
			          Penggantian JTM penghantar kecil menjadi A3CS 150 mm3
			        </a>
			      </h4>
			    </div>
