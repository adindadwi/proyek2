                   ...
                   <table id="lok_rejtm" class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								<a class="btn btn-xs btn-danger" title="Hapus Data"  href="<?php echo base_url()?>UpRTM/deletelok/<?php echo $listhasil->id_lokmm2?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data' href='".base_url()."UpRTM/addline/".$listhasil->id_lokmm2."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Edit</a>";
								}else{ ?>
                       ...
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								echo "<tr>";
									...
									echo "<td class='text-center'>".$listhasil->jumlah_X."</td>";
									?>
								<td width="175" class="text-center"><a class="btn btn-xs btn-danger" title="Hapus Data"  href="<?php echo base_url()?>UpRTM/deletelok1/<?php echo $listhasil->id_lokmm3?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data Member' href='".base_url()."UpRTM/addline1/".$listhasil->id_lokmm3."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Edit</a></td>";
								echo "</tr>";
								$i++;
								endforeach;
								?>
