...
<section class="content-header">
     <h1>PRK.2015 DJT.1.1</h1>
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url()?>RekonfigJTM"><?php foreach($hasil as $listhasil): echo $listhasil->rayon; endforeach;?></a></li>
			          ...
			          if($cekgmb==0)
					  ...
					  else
						 {
							foreach($gambar as $listhasil1):
						 	echo "<img style='height: 600px; width: 1020px;' src='".base_url()."assets/img/lokasi/Rekonfig JTM/".$listhasil1->rayon."/".$listhasil1->gambar."'/>";
							endforeach;
						}
						?>                               
			      </div>
