                       ...
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								echo "<tr>";
									...
									?>
								<td width="175" class="text-center"><a class="btn btn-xs btn-danger" title="Hapus Data"  href="<?php echo base_url()?>rehab_jar_tm/deletelok/<?php echo $listhasil->id_2lomm?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data' href='".base_url()."rehab_jar_tm/addline/".$listhasil->id_2lomm."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Edit</a></td>";
								echo "</tr>";
								$i++;
								endforeach;
								?>
                       ...
                       <thead bgcolor="#f9f9f9">
						...
						<tbody>
							<?php
								...
								<a class="btn btn-xs btn-danger" title="Hapus Data"  href="<?php echo base_url()?>rehab_jar_tm/deletelok1/<?php echo $listhasil1->id_3lomm?>" onclick="return confirm('Anda Yakin Akan Menghapus DATA ?')"><i class="glyphicon glyphicon-trash"></i>&nbsp;Hapus</a>
								<?php echo "<a class='btn btn-xs btn-success' title='Ubah Data Member' href='".base_url()."rehab_jar_tm/addline2/".$listhasil1->id_3lomm."'><i class='glyphicon glyphicon-edit'></i>&nbsp;Edit</a>";
								}else{ ?>
