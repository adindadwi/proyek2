  ...
  <h1>Input <small>Line</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-archive"></i> Pembangunan Penyulang Baru</a></li>
              <li><a href="<?php echo base_url()?>rehab_jar_tm"><?php foreach($hasil as $listhasil): echo $listhasil->ryn; endforeach;?></a></li>
...
<?php echo $_SESSION['log'];
 ...
 ?>
	  ...
	  <div class="row">
    			 ...
    			 <table class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<?php
								...
								echo "<tr>";
									echo "<td class='text-center' rowspan='2'>".$listhasil->gmr_no."</td>";
									echo "<td rowspan='2' class='text-center'>".$listhasil->lks."</td>";
									echo "<td rowspan='2' class='text-center'>".$listhasil->ex_sist."</td>";
			...
			<?php echo form_open_multipart("rehab_jar_tm/uploadgambar"); ?>
			<table>
				<tr>
					<?php
					foreach($hasil as $listhasil):
					echo "<input type='hidden' value='".$listhasil->id_2lomm."' name='id_lok'>";
					endforeach;
					?>
			...
			<div class="panel-group" id="accordion1">
			  <div class="panel panel-danger">
			    ...
			    <form action="<?php echo base_url()?>rehab_jar_tm/addmvline" method="POST" name="mvline">
			    <div style="border: 0px solid 00000; color: black; font-family: arial; height: auto; overflow: auto; padding: 4px; text-align: left; width: auto;">
					...
					<table class="table table-bordered" width="100%" id="tab_logic">
						...
						<?php
						foreach($hasil as $listhasil):
						echo "<input type='hidden' value='".$listhasil->id_2lomm."' name='id_2lomm'>";
						endforeach;
						?>
							<tr id='addr0'>
