<section class="content-header">
  <h1>Input <small>Line</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-archive"></i> Pembangunan Penyulang Baru</a></li>
        <li><a href="<?php echo base_url()?>rehab_jar_tm"><?php foreach($hasil1 as $listhasil): echo $listhasil->ryn; endforeach;?></a></li>
      ...
      <!-- Page content --><div class="row">
			...
			<table>
				<tr>
					<?php
					foreach($hasil1 as $listhasil1):
					echo "<input type='hidden' value='".$listhasil1->id_3lomm."' name='id_lok'>";
					endforeach;
					?>
