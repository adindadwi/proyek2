                       ...
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								echo "<tr>";
									...
									echo "<td rowspan='2' class='text-center'>".$listhasil->gmb22."</td>";
			          ...
			          if($cekgmb==0)
					  ...
					  else
						 {
							foreach($gambar as $listhasil1):
						 	echo "<img style='height: 600px; width: 1020px;' src='".base_url()."assets/img/lokasi/rehab_jar_tr/".$listhasil1->gambar."'/>";
							endforeach;
						}
						?>                               
			      </div>
