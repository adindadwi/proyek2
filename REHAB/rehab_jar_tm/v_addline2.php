<section class="content-header">
  <h1>Input <small>Line</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-archive"></i> Rehab Jaringan TM</a></li>
        <li><a href="<?php echo base_url()?>rehab_jar_tm"><?php foreach($hasil1 as $listhasil1): echo $listhasil1->ryn; endforeach;?></a></li>
...
<?php echo $_SESSION['log'];
 ...
 ?>
      <!-- Page content --><div class="row">
    			 ...
    			 <table class="table table-bordered table-hover">
                       <thead bgcolor="#f9f9f9">
							...
							<?php
								...
								echo "<tr>";
									echo "<td class='text-center' rowspan='2'>".$listhasil1->gmr_no."</td>";
									echo "<td rowspan='2' class='text-center'>".$listhasil1->lks."</td>";
									echo "<td rowspan='2' class='text-center'>".$listhasil1->ex_sist."</td>";
									echo "<td class='text-center'>".$listhasil1->jlm_x."</td>";
									echo "<td class='text-center'><input type='text' placeholder='Silahkan Masukkan Keterangan di bawah' class='form-control1' name='z' readonly='yes'></td>";
								echo "</tr>";
								endforeach;
								?>
							</tbody>
			...
			<?php echo form_open_multipart("rehab_jar_tm/uploadgambar1"); ?>
			<table>
				<tr>
					<?php
					foreach($hasil1 as $listhasil1):
					echo "<input type='hidden' value='".$listhasil1->id."' name='id_lok'>";
					echo "<input type='hidden' value='".$listhasil1->ryn."' name='rayon'>";
					endforeach;
					?>
			...
			<div class="panel-group" id="accordion1">
			  <div class="panel panel-danger">
			    ...
			    <form action="<?php echo base_url()?>rehab_jar_tm/addmvline1" method="POST" name="mvline">
			    <div style="border: 0px solid 00000; color: black; font-family: arial; height: auto; overflow: auto; padding: 4px; text-align: left; width: auto;">
					...
					<table class="table table-bordered" width="100%" id="tab_logic">
						...
						<?php
						foreach($hasil1 as $listhasil1):
						echo "<input type='hidden' value='".$listhasil1->id_3lomm."' name='id_3lomm'>";
						endforeach;
						?>
							<tr id='addr0'>
								...
								<td style="vertical-align: middle;" rowspan="2"><input type='text'  maxlength='100' name='y1' class='form-control1 input-md'  /></td>
