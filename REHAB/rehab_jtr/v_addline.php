...
<section class="content-header">
     <h1>PRK.2015 DJT.1.6</h1>
            <ol class="breadcrumb">
               <li><a href="#"><i class="fa fa-archive"></i> <?=$title?></a></li>
              <li><a href="<?php echo base_url()?>rehab_jar_tr"><?php foreach($hasil as $listhasil): echo $listhasil->rayon2; endforeach;?></a></li>
                       ...
                       <thead bgcolor="#f9f9f9">
							...
							<tbody>
								...
								echo "<tr>";
									...
									echo "<td class='text-center' style='vertical-align: middle;'>".$listhasil->jumlahXX."</td>";
                       ...
                       <thead bgcolor="#f9f9f9">							
							...
							?>
			        			...
			        			?>
									<tr id='addrw0'>
			        				<td class="text-center">M</td>
									<td><input type="text" value="<?php echo $list->rhb_TR1 ?>"  maxlength="3" name="a" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR2 ?>"  maxlength="3" name="b" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR3 ?>"  maxlength="3" name="c" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR3A ?>"  maxlength="3" name="d" class="form-control" id="dise" disabled/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR4 ?>"  maxlength="3" name="e" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR4A ?>"  maxlength="3" name="f" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)"  onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR5 ?>"  maxlength="3" name="g" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR6 ?>"  maxlength="3" name="h" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR6A ?>"  maxlength="3" name="i" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_TR7 ?>"  maxlength="3" name="j" class="form-control" id="dise1" disabled/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->konduktor ?>" maxlength="3" name="k" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									...
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_ins ?>" maxlength="3" name="kk" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_nonins ?>"  maxlength="3" name="ll" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_gw ?>" maxlength="3" name="m" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_gwn ?>"  maxlength="3" name="n" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type="text" value="<?php echo $list->rhb_hgw ?>" maxlength="3" name="o" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_hgwn ?>" maxlength="7" name="p" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_sp ?>" maxlength="3" name="q" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td >
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_utama ?>" maxlength="3" name="r" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_nonutama ?>" maxlength="3" name="s" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_srutama ?>" maxlength="3" name="t" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td style="vertical-align: middle;" rowspan="2"><input type="text" value="<?php echo $list->rhb_groundluar ?>" maxlength="3" name="u" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" onFocus="startCalc();" onBlur="stopCalc();"/></td>
								</tr>
			        			<tr id='addrw1'>
			        				<td class="text-center">UB</td>
			        				<td><input type='text' value="<?php echo $list->rhb_TR12 ?>" maxlength='3' name='a1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_TR22 ?>" maxlength='3' name='b1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_TR32 ?>" maxlength='3' name='c1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_3A2 ?>" maxlength='3' name='d1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_42 ?>" maxlength='3' name='e1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_4A2 ?>" maxlength='3' name='f1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_TR52 ?>" maxlength='3' name='g1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_TR62 ?>" maxlength='3' name='h1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_TR6A2 ?>" maxlength='3' name='i1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type='text' value="<?php echo $list->rhb_TR72 ?>" maxlength='3' name='j1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type='text' value="<?php echo $list->rhb_gw2 ?>" maxlength='3' name='m1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
			        				<td><input type='text' value="<?php echo $list->rhb_gwn2 ?>" maxlength='3' name='n1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
									<td><input type='text' value="<?php echo $list->rhb_hgw2 ?>" maxlength='3' name='o1' onKeyPress="return goodchars(event,'0123456789',this)" class='form-control input-md' onFocus="startCalc();" onBlur="stopCalc();"/></td>
								<?php 
								endforeach; 
								}
								?>
			          ...
			          if($cekgmb==0)
					  ...
					  else
						 {
							foreach($gambar2 as $listhasil1):
						 	echo "<img style='height: 600px; width: 1020px;' src='".base_url()."assets/img/lokasi/rehab_jar_tr/".$listhasil1->gambar2."'/>";
							endforeach;
						}
						?>                               
			      </div>
