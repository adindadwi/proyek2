<?php
	class m_rehab_jar_tm extends CI_Model
	{
		...
		{
			$hasil1=$this->db->query("SELECT COUNT(*) AS count FROM mvtic_jtm_reha WHERE mm3_id='".$id."'");
			return $hasil1;
		}
		...
		function simpanlokasitodb($data)
		{
			...
			$jlm_x=$data['jlm_x'];
			$ryn=$data['ryn'];
			$query="insert into lok_rehab_jar_tm1 values('','".$id_2lomm."','".$gmr_no."','".$lks."','".$ex_sist."','".$jlm_x."','".$ryn."')";
			$hasil=$this->db->query($query);
			return $hasil;
		}
		function simpanlokasitodb1($data)
		{
			...
			$jlm_x=$data['jlm_x'];
			$ryn=$data['ryn'];
			$query="insert into kol_rhab_jar_tm2 values('','".$id_3lomm."','".$gmr_no."','".$lks."','".$ex_sist."','".$jlm_x."','".$ryn."')";
			$hasil=$this->db->query($query);
			return $hasil1;
		}
		...
		{
			$hasil=$this->db->query("SELECT * FROM lok_rehab_jar_tm1 WHERE id='".$id."'");
			return $hasil;
		}
		function showlokaddlinefromdb2($id)
		{
			$hasil1=$this->db->query("SELECT * FROM kol_rhab_jar_tm2 WHERE id='".$id."'");
			return $hasil1;
		}
		...
		{
			$query="DELETE FROM lok_rehab_jar_tm1 WHERE id = '".$id."'";
			$hasil=$this->db->query($query);
			return $hasil;
		}
		function deletelokfromdb1($id)
		{
			$query="DELETE FROM kol_rhab_jar_tm2 WHERE id = '".$id."'";
